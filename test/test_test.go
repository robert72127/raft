...
func For2023TestFollowerFailure(t *testing.T) {
	servers := 3
	cfg := make_config(t, servers, false, false)
	defer cfg.cleanup()
...
func For2023TestLeaderFailure(t *testing.T) {
	servers := 3
	cfg := make_config(t, servers, false, false)
	defer cfg.cleanup()
...
func internalChurn(t *testing.T, unreliable bool) {
	...
	if unreliable {
		cfg.begin("Test : unreliable churn")
	} else {
...
func TestReliableChurn2(t *testing.T) {
	internalChurn(t, false)
}

func TestUnreliableChurn2(t *testing.T) {
